...
describe("create_guild_channel", () => {
  it("should_call_POST_guild_channels_with_body_when_creating", async () => {
    ...
    expect(callApiSpy).toHaveBeenCalledWith("POST", "/guilds/g1/channels", { name: "general", type: 0 }, undefined, "setup");
  });
});
...
describe("modify_welcome_screen", () => {
  it("should_call_PATCH_welcome_screen_with_body_when_modifying", async () => {
    ...
    expect(callApiSpy).toHaveBeenCalledWith("PATCH", "/guilds/g1/welcome-screen", { enabled: true, description: "Welcome!" }, undefined, "update");
  });
});
...
describe("modify_onboarding", () => {
  it("should_call_PUT_onboarding_with_body_when_modifying", async () => {
    ...
    expect(callApiSpy).toHaveBeenCalledWith("PUT", "/guilds/g1/onboarding", { prompts: [], default_channel_ids: ["ch1"], enabled: true }, undefined, "setup");
  });
});
...
describe("begin_prune", () => {
  it("should_call_POST_prune_with_body_and_reason_when_pruning", async () => {
    ...
    expect(callApiSpy).toHaveBeenCalledWith("POST", "/guilds/g1/prune", { days: 30, compute_prune_count: true }, undefined, "cleanup");
  });
});
