...
import {
  ...
  CheckUserSubSchema,
  CreateClipSchema,
  CreateEventSubSchema,
  CreateScheduleSegmentSchema,
  DeleteEventSubSchema,
  DeleteScheduleSegmentSchema,
  DeleteVideosSchema,
  GetClipsSchema,
  GetEventSubSchema,
  GetGamesSchema,
...
export function registerContentTools(server: McpServer, client: TwitchClient): void {
  ...
  server.tool(
    ...
    "Create a scheduled stream segment",
    CreateScheduleSegmentSchema.shape,
    async (p) =>
      withErrorHandler(async () => {
  ...
  server.tool(
    ...
    "Update a scheduled stream segment",
    UpdateScheduleSegmentSchema.shape,
    async (p) =>
      withErrorHandler(async () => {
  ...
  server.tool(
    ...
    DeleteScheduleSegmentSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
