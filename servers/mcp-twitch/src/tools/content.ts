...
export function registerContentTools(server: McpServer, client: TwitchClient): void {
  ...
  server.tool("create_clip", "Create a clip of a live stream", CreateClipSchema.shape, async (p) => {
    return toolResult(await client.callApi("POST", "/clips", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("get_clips", "Get clips by broadcaster, game, or ID", GetClipsSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/clips", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  // Schedule
  server.tool("get_schedule", "Get a channel's stream schedule", GetScheduleSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/schedule", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });
  ...
  server.tool("delete_schedule_segment", "Delete a scheduled stream segment", DeleteScheduleSegmentSchema.shape, async (p) => {
    return toolResult(await client.callApi("DELETE", "/schedule/segment", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });
  ...
  server.tool("search_categories", "Search for games/categories by name", SearchCategoriesSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/search/categories", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("search_channels", "Search for channels (optionally live only)", SearchChannelsSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/search/channels", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  // Games
  server.tool("get_games", "Get game/category info by ID, name, or IGDB ID", GetGamesSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/games", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("get_top_games", "Get top games/categories on Twitch", GetTopGamesSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/games/top", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  // Users
  server.tool("get_users", "Get user info by ID or login name", GetUsersSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/users", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("update_user", "Update authenticated user's description", UpdateUserSchema.shape, async (p) => {
    return toolResult(await client.callApi("PUT", "/users", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("get_user_blocks", "Get blocked users list", GetUserBlocksSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/users/blocks", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("block_user", "Block a user", BlockUnblockUserSchema.shape, async (p) => {
    return toolResult(await client.callApi("PUT", "/users/blocks", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("unblock_user", "Unblock a user", BlockUnblockUserSchema.shape, async (p) => {
    return toolResult(await client.callApi("DELETE", "/users/blocks", undefined, { target_user_id: p.target_user_id }));
  });
  ...
  server.tool("check_user_subscription", "Check if a user is subscribed to a channel", CheckUserSubSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/subscriptions/user", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });
  ...
  server.tool("create_eventsub_subscription", "Create an EventSub subscription", CreateEventSubSchema.shape, async (p) => {
    return toolResult(await client.callApi("POST", "/eventsub/subscriptions", p as Record<string, unknown>));
  });

  server.tool("get_eventsub_subscriptions", "Get EventSub subscriptions", GetEventSubSchema.shape, async (p) => {
    return toolResult(await client.callApi("GET", "/eventsub/subscriptions", undefined, p as Record<string, string | number | boolean | string[] | undefined>));
  });

  server.tool("delete_eventsub_subscription", "Delete an EventSub subscription", DeleteEventSubSchema.shape, async (p) => {
    return toolResult(await client.callApi("DELETE", "/eventsub/subscriptions", undefined, { id: p.id }));
  });
}
