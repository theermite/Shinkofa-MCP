...
export function registerChatTools(server: McpServer, client: TwitchClient): void {
  server.tool("get_chatters", "Get list of users currently in chat", GetChattersSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/chat/chatters", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("get_global_emotes", "Get global Twitch emotes", {}, async () =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/chat/emotes/global"))
    )
  );
  ...
  server.tool("get_global_badges", "Get global Twitch chat badges", {}, async () =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/chat/badges/global"))
    )
  );

  server.tool("get_chat_settings", "Get chat settings (slow mode, follower-only, sub-only, etc.)", GetChatSettingsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/chat/settings", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("send_shoutout", "Send a Shoutout to another broadcaster in chat", SendShoutoutSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("POST", "/chat/shoutouts", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("delete_chat_message", "Delete a specific message or clear all chat", DeleteChatMessageSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("DELETE", "/chat/messages", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("update_chat_color", "Update user chat name color", UpdateChatColorSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("PUT", "/chat/color", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("get_vips", "Get VIPs for a channel", GetVIPsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/channels/vips", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("add_vip", "Add a VIP to a channel", AddRemoveVIPSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("POST", "/channels/vips", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("remove_vip", "Remove a VIP from a channel", AddRemoveVIPSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("DELETE", "/channels/vips", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
}
