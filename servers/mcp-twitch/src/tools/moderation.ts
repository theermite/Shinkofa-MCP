...
export function registerModerationTools(server: McpServer, client: TwitchClient): void {
  server.tool("get_banned_users", "Get list of banned/timed-out users", GetBannedUsersSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/moderation/banned", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("unban_user", "Unban a user or remove a timeout", UnbanUserSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("DELETE", "/moderation/bans", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("get_blocked_terms", "Get blocked terms for a channel", GetBlockedTermsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/moderation/blocked_terms", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("remove_blocked_term", "Remove a blocked term", RemoveBlockedTermSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("DELETE", "/moderation/blocked_terms", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("get_moderators", "Get list of channel moderators", GetModeratorsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/moderation/moderators", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("add_moderator", "Add a channel moderator", AddRemoveModeratorSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("POST", "/moderation/moderators", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("remove_moderator", "Remove a channel moderator", AddRemoveModeratorSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("DELETE", "/moderation/moderators", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );

  server.tool("get_shield_mode", "Get Shield Mode status", GetShieldModeSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/moderation/shield_mode", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("get_automod_settings", "Get AutoMod settings for a channel", GetAutoModSettingsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/automod/settings", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
  ...
  server.tool("get_unban_requests", "Get unban requests for a channel", GetUnbanRequestsSchema.shape, async (p) =>
    withErrorHandler(async () =>
      toolResult(await client.callApi("GET", "/moderation/unban_requests", undefined, p as Record<string, string | number | boolean | string[] | undefined>))
    )
  );
