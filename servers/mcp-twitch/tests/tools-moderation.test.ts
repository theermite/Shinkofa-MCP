...
describe("moderation tools", () => {
  ...
  it("should_unban_user_when_called", async () => {
    ...
    expect(ctx.callApiSpy).toHaveBeenCalledWith("DELETE", "/moderation/bans", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
      user_id: "3",
    });
  ...
  it("should_get_blocked_terms_when_called", async () => {
    ...
    expect(ctx.callApiSpy).toHaveBeenCalledWith("GET", "/moderation/blocked_terms", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
    });
  });
  ...
  it("should_remove_blocked_term_when_called", async () => {
    ...
    expect(ctx.callApiSpy).toHaveBeenCalledWith("DELETE", "/moderation/blocked_terms", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
      id: "term1",
    });
  ...
  it("should_add_moderator_when_called", async () => {
    ...
    expect(ctx.callApiSpy).toHaveBeenCalledWith("POST", "/moderation/moderators", undefined, {
      broadcaster_id: "1",
      user_id: "2",
    });
  });
  ...
  it("should_remove_moderator_when_called", async () => {
    ...
    await handler({ broadcaster_id: "1", user_id: "2" });
    expect(ctx.callApiSpy).toHaveBeenCalledWith("DELETE", "/moderation/moderators", undefined, {
      broadcaster_id: "1",
      user_id: "2",
    });
  });
  ...
  it("should_get_shield_mode_when_called", async () => {
    ...
    await handler({ broadcaster_id: "1", moderator_id: "2" });
    expect(ctx.callApiSpy).toHaveBeenCalledWith("GET", "/moderation/shield_mode", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
    });
  });
  ...
  it("should_get_automod_settings_when_called", async () => {
    ...
    await handler({ broadcaster_id: "1", moderator_id: "2" });
    expect(ctx.callApiSpy).toHaveBeenCalledWith("GET", "/automod/settings", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
    });
  });
  ...
  it("should_get_unban_requests_when_called", async () => {
    ...
    await handler({ broadcaster_id: "1", moderator_id: "2" });
    expect(ctx.callApiSpy).toHaveBeenCalledWith("GET", "/moderation/unban_requests", undefined, {
      broadcaster_id: "1",
      moderator_id: "2",
    });
  });
  ...
  it("should_resolve_unban_request_when_called", async () => {
    ...
    expect(ctx.callApiSpy).toHaveBeenCalledWith(
      ...
      { unban_request_id: "req1", status: "approved", resolution_text: undefined },
      { broadcaster_id: "1", moderator_id: "2" },
    );
  });
  ...
  it("should_return_error_when_TwitchError_thrown", async () => {
    ...
    const handler = ctx.registeredTools.get("ban_user")!;
    const result = (await handler({ broadcaster_id: "1", moderator_id: "2", user_id: "3", reason: "x" })) as {
      isError: boolean;
      content: { text: string }[];
    };
