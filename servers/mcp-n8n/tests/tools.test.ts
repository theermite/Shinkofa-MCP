...
describe("Workflow tool registration", () => {
  ...
  it("should_register_all_expected_workflow_tool_names", () => {
    ...
    expect(registered).toEqual([
      ...
      "run_workflow", "get_workflow_tags", "set_workflow_tags",
    ]);
...
describe("Resource tool registration", () => {
  ...
  it("should_register_all_expected_resource_tool_names", () => {
    ...
    expect(registered).toEqual([
      ...
      "create_credential", "delete_credential", "get_credential_schema",
      "list_tags", "create_tag", "get_tag", "update_tag", "delete_tag",
      "list_variables", "create_variable", "delete_variable",
      "list_users", "get_me", "generate_audit", "raw_api_call",
    ]);
