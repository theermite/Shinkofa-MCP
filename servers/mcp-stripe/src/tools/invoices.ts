...
export function registerInvoiceTools(
    ...
    async (p) =>
      withErrorHandler(async () => {
        ...
        return toolResult(
          await client.callApi(
            "POST",
            `/invoices/${encodeURIComponent(invoice_id)}/finalize`,
            params,
          ),
        );
      }),
    ...
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "POST",
            `/invoices/${encodeURIComponent(p.invoice_id)}/send`,
          ),
        ),
      ),
  );
    ...
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "POST",
            `/invoices/${encodeURIComponent(p.invoice_id)}/void`,
          ),
        ),
      ),
  );
  ...
  server.tool(
    ...
    DeleteDraftInvoiceSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
