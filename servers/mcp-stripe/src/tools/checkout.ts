...
export function registerCheckoutTools(
  ...
  server.tool(
    ...
    GetCheckoutSessionSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
  ...
  server.tool(
    ...
    ListCheckoutSessionsSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
    ...
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "POST",
            `/checkout/sessions/${encodeURIComponent(p.session_id)}/expire`,
          ),
        ),
      ),
  );
  ...
  server.tool(
    "get_payment_link",
    "Get a payment link",
    GetPaymentLinkSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "GET",
            `/payment_links/${encodeURIComponent(p.payment_link_id)}`,
          ),
        ),
      ),
  );
    ...
    async (p) =>
      withErrorHandler(async () => {
        ...
        return toolResult(
          await client.callApi(
            "POST",
            `/payment_links/${encodeURIComponent(payment_link_id)}`,
            params,
          ),
        );
      }),
