...
export function registerFinanceTools(
  ...
  server.tool(
    ...
    async () =>
      withErrorHandler(async () =>
        toolResult(await client.callApi("GET", "/balance")),
      ),
  );
  ...
  server.tool(
    ...
    CancelPayoutSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "POST",
            `/payouts/${encodeURIComponent(p.payout_id)}/cancel`,
          ),
        ),
      ),
  );
    ...
    async (p) =>
      withErrorHandler(async () => {
        ...
        return toolResult(
          await client.callApi(
            "POST",
            `/disputes/${encodeURIComponent(dispute_id)}`,
            params,
          ),
        );
      }),
  ...
  server.tool(
    "close_dispute",
    "Close a dispute (accept the chargeback)",
    CloseDisputeSchema.shape,
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "POST",
            `/disputes/${encodeURIComponent(p.dispute_id)}/close`,
          ),
        ),
      ),
  );
    ...
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "GET",
            `/webhook_endpoints/${encodeURIComponent(p.webhook_id)}`,
          ),
        ),
      ),
  );
    ...
    async (p) =>
      withErrorHandler(async () => {
        ...
        return toolResult(
          await client.callApi(
            "POST",
            `/webhook_endpoints/${encodeURIComponent(webhook_id)}`,
            params,
          ),
        );
      }),
    ...
    async (p) =>
      withErrorHandler(async () =>
        toolResult(
          await client.callApi(
            "GET",
            `/events/${encodeURIComponent(p.event_id)}`,
          ),
        ),
      ),
  );
