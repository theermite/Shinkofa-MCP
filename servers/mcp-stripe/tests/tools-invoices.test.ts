...
describe("Invoice tools — callbacks", () => {
  ...
  it("should_get_invoice_with_encoded_id", async () => {
    ...
    expect(callApiSpy).toHaveBeenCalledWith("GET", "/invoices/in_123", undefined);
  });
