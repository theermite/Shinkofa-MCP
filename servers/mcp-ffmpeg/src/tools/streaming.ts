...
import { HlsSchema, StreamSchema } from "../lib/schemas.js";
    ...
    async (params) => {
      return withErrorHandler(async () => {
        ...
        if (!params.gpu) {
          ...
          const bufNum = parseInt(params.bitrate_video, 10) * 2;
    ...
    async (params) => {
      return withErrorHandler(async () => {
        ...
        args.push(
          ...
          "hls",
          "-hls_time",
          String(params.segment_duration),
          "-hls_list_size",
          "0",
          "-hls_segment_filename",
          join(params.output_dir, "segment_%03d.ts"),
