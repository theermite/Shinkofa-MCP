...
describe("NormalizeAudioSchema", () => {
  it("should accept with custom LUFS", () => {
    expect(
      NormalizeAudioSchema.safeParse({
        input: "audio.mp3",
