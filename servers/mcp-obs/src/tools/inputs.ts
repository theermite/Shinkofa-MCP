...
export function registerInputTools(server: McpServer, obs: OBSClient): void {
  ...
  server.tool("obs-get-input-list", "List all inputs/sources", {
  ...
  server.tool("obs-get-input-kind-list", "List available input types", {
    unversioned: z.boolean().optional(),
  }, async (args) => {
    return withErrorHandler(async () => toolResult(await obs.call("GetInputKindList", args)));
  });

  server.tool("obs-get-input-settings", "Get settings of an input", {
  ...
  server.tool("obs-set-input-settings", "Update input settings", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  ...
  server.tool("obs-create-input", "Create a new input/source", {
  ...
  server.tool("obs-remove-input", "Remove an input (and all its scene items)", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  }, async (args) => {
  ...
  server.tool("obs-set-input-name", "Rename an input", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  ...
  server.tool("obs-get-input-mute", "Get mute state of an input", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  }, async (args) => {
  ...
  server.tool("obs-set-input-mute", "Set mute state", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  ...
  server.tool("obs-toggle-input-mute", "Toggle mute", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  }, async (args) => {
  ...
  server.tool("obs-get-input-volume", "Get volume of an input", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
  }, async (args) => {
  ...
  server.tool("obs-set-input-volume", "Set volume (dB or multiplier)", {
    inputName: z.string().optional(),
    inputUuid: z.string().optional(),
