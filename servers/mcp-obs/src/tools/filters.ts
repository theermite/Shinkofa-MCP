...
export function registerFilterTools(server: McpServer, obs: OBSClient): void {
  server.tool("obs-get-source-filter-list", "List filters on a source", {
  ...
  server.tool("obs-get-source-filter", "Get a specific filter", {
    sourceName: z.string().optional(),
    sourceUuid: z.string().optional(),
    filterName: z.string(),
  }, async (args) => {
  ...
  server.tool("obs-create-source-filter", "Add a filter to a source", {
    sourceName: z.string().optional(),
    sourceUuid: z.string().optional(),
    filterName: z.string(),
    filterKind: z.string(),
  ...
  server.tool("obs-set-source-filter-settings", "Update filter settings", {
    sourceName: z.string().optional(),
    sourceUuid: z.string().optional(),
    filterName: z.string(),
  ...
  server.tool("obs-set-source-filter-enabled", "Enable/disable a filter", {
    sourceName: z.string().optional(),
    sourceUuid: z.string().optional(),
    filterName: z.string(),
  ...
  server.tool("obs-remove-source-filter", "Remove a filter", {
    sourceName: z.string().optional(),
    sourceUuid: z.string().optional(),
    filterName: z.string(),
  }, async (args) => {
